 ...
 */
export function parseWithBabel(content: string, filePath?: string) {
 ...
 */
export function extractJSDoc(node: any): string | undefined {
 ...
 */
export function getLinesWithContext(
  lines: string[],
  targetLine: number,
 ...
 */
export function findSearchableFiles(
  dirPath: string,
  pattern?: string,
  includeNonCode: boolean = false
): string[] {
  const results: string[] = [];
